...
def main():
    ...
    parser = ArgumentParser(description="Train a model from feature vector data.")
    parser.add_argument(
        "--model_name",
        type=str,
        required=True,
    ...
    set_global_seed()
    logger = setup_logging(model_name, "train_from_features")
    ...
    for epoch in epochs_iter:
        ...
        val_loss, val_logits, val_labels = model.eval_classifier_epoch(
            val_dataloader,
            criterion)
